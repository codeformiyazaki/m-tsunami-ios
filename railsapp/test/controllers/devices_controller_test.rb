...
class DevicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create device" do
    assert_difference('Device.count') do
      post devices_url, params: { device: { active: @device.active, desc: @device.desc, name: @device.name } }
    end
  ...
  test "should update device" do
    patch device_url(@device), params: { device: { active: @device.active, desc: @device.desc, name: @device.name } }
